defmodule ProbandoPhoenixLiveViewWeb.ConsumirApiView do
  use Phoenix.LiveView

  def render(assigns) do
    ProbandoPhoenixLiveViewWeb.PageView.render("consumir.html", assigns)
  end

  def mount(session, socket) do
    stream_pid = Process.spawn(ProbandoPhoenixLiveView.Consumir, :edits, [self()], [:link])
